...
contract ArtToken is Ownable, ERC721 {
    ...
    //  * @param _metaDataURI for the new token
    //  * @param _metaData metadata JSONified string
    //  * @param _contractSanction address
    //  */
    // function createPub(
    //     string calldata _metaDataURI,
    //     string calldata _metaData,
    //     address _contractSanction
    // )
    //     external
    // {
    //     // Create the new asset and allow contractSanction to manage it
    ...
    //     // execute create order in destination contractSanction
    //     // (bool success, ) = _contractSanction.call(_encodedCallData);
    //     // require(
    //     //     success,
    //     //     "contractSanction: failed to execute publish order"
    //     // );
    // }
